        ...
        <section class="flex">
            ...
            <form class="form-search">
                ...
                <h1 class="headings" style="color: var(--main-color);font-size: 2rem;margin-bottom: 0;width: 100%;
                    ...
                    <marquee behavior="smooth" direction="left" style="cursor: pointer;">Call or whatsApp me on (+261)034-24-376-38 or email me using this email address asdonsoter@gmail.com</marquee>
                </h1>
            </form>
            <div class="icons">
